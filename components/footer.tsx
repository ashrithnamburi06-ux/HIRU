...
const footerLinks = {
  shop: [
    ...
    { name: "New Arrivals", href: ROUTES.category("new-in") },
    ...
    { name: "Ethnic Wear", href: ROUTES.category("ethnic") },
    { name: "Accessories", href: ROUTES.category("accessories") },
  ],
  help: [
    { name: "Contact", href: ROUTES.contact },
    { name: "Shipping Info", href: ROUTES.contact },
    { name: "Returns & Exchanges", href: ROUTES.contact },
    { name: "Track Order", href: ROUTES.profile },
    { name: "FAQs", href: ROUTES.contact },
  ],
  about: [
    { name: "Our Story", href: ROUTES.about },
    { name: "Craftsmanship", href: ROUTES.about },
    { name: "Sustainability", href: ROUTES.about },
    { name: "Careers", href: ROUTES.contact },
    { name: "Press", href: ROUTES.contact },
  ],
}
